...
router.get('/app/discounts', function (req, res, next) {

    let url = 'https://' + req.query.shop + '/admin/price_rules/#{price_rule_id}/discount_codes.json';
...
router.get('/app/price_rules', function (req, res, next) {

    let url = 'https://' + req.query.shop + '/admin/price_rules.json';
